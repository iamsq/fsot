...
/**
 * This interface defines the public methods that a MySet factory must implement.
 */
public interface MySetFactory
{
  /**
   * Create a set that is an instance of the same class as the parameter object.
   * @param setClass A class object used to determine the class of the set to instantiate.
   * @return The new set.
  ...
  /**
   * Create a set that is an instance of the same class as the parameter object, with the
