...
/**
 * The default set factory. The getInstance method will return a new instance of the MySet
 * implementation class determined by the class of the parameter.
 */
public class DefaultMySetFactory implements MySetFactory
{
  ...
  public MySet getInstance(Class setClass, int size) throws MySetException
  {
    ...
    }else if (setClass.equals(ArrayMySet.class)){
        return new ArrayMySet(size);
    }else if (setClass.equals(LinkedListMySet.class)){
